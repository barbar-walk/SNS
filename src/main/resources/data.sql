...
-- Wed May  8 14:42:48 2024
-- Model: barbar_sns    Version: 1.0
...
-- -----------------------------------------------------
-- Table `barbar_sns`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barbar_sns`.`users` (
...
-- -----------------------------------------------------
-- Table `barbar_sns`.`posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barbar_sns`.`posts` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
-- -----------------------------------------------------
-- Table `barbar_sns`.`friends`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barbar_sns`.`friends` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `users_id` BIGINT NOT NULL COMMENT 'ユーザーID',
...
-- -----------------------------------------------------
-- Table `barbar_sns`.`post_comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barbar_sns`.`post_comments` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
-- -----------------------------------------------------
-- Table `barbar_sns`.`post_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barbar_sns`.`post_images` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `posts_id` BIGINT NOT NULL COMMENT '投稿ID',
  `users_id` BIGINT NOT NULL COMMENT 'ユーザーID',
